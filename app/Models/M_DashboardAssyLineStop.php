...
class M_DashboardAssyLineStop extends Model
{
    ...
    public function get_data_total_line_stop_by_month($bulan, $line)
    {
    ...
    public function get_loading_time_by_month($bulan, $line) 
    {
        if ($line == null OR $line == 0) {
    ...
    public function get_data_line_stop_by_month($bulan, $line)
    {
        if ($line == null || $line == 0) {
    ...
    public function get_year_to_date_line_stop($line)
    {
        $tahun = date('Y');
    ...
    public function get_data_average_line_stop_by_month($bulan, $line)
    {
        if ($line == null || $line == 0) {
    ...
    public function get_data_line_stop_all_line_by_month($bulan, $line)
    {
        if ($line == null || $line == 0) {
            $query = $this->db->query('SELECT MONTH(tanggal_produksi) AS month,SUM(total_line_stop) AS total_line_stop, SUM(loading_time) AS loading_time
                                        FROM lhp_produksi2 
