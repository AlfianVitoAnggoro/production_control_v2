  ...
  function data_cos() {
    ...
    <?php foreach ($data_detail_lhp_cos as $ddc) { ?>
      ...
      $('.form_cos').append(`
          ...
          <td>
              <input type="text" class="form-control" name="strap_dross[]" id="strap_dross_${baris}" value="<?= $ddc['strap_dross'] ?>">
          </td>
          <td>
  ...
  function add_cos() {
      ...
      $('.form_cos').append(`
          <tr class="form" id="form_${baris}">
              ...
              <td>
                  <input type="text" class="form-control" name="strap_dross[]" id="strap_dross_${baris}" value="">
              </td>
              <td>
