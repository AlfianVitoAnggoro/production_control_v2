                  ...
                  <div class="d-flex justify-content-between">
                    ...
                    <div>
                      <div class="d-flex">
                        ...
                        <!-- <form action="<?= base_url() ?>master_man_power_kasubsie/detail_man_power/delete" method="POST">
                          ...
                          <tr>
                            ...
                            <td>
                              <div class="d-flex justify-content-center">
                                <!-- <a href="<?= base_url() ?>master_man_power_kasubsie/detail_man_power/<?= $d_mp['id_man_power'] ?>" class="btn btn-primary" style="width: 150px">Edit</a>
                                &nbsp
                                <form action="<?= base_url() ?>master_man_power_kasubsie/detail_man_power/delete" method="POST">
