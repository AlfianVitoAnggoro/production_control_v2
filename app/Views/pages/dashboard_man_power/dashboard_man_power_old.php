  ...
  <section class="content p-0">
    ...
    <?php for ($i = 0; $i < count($line); $i++) { ?>
      ...
      <div class="d-flex justify-content-between" style="width: 100vw">
        <div class="d-flex" style="margin-left: 20px; width: 100%">
          <div class="d-flex justify-content-center align-items-center flex-column mb-2 mx-1" style="background-color: #213363; color: white; width: 100px">
        ...
        <div class="mb-2" style="margin-right: 23px;">
          <table class="table bg-white" style="height: 100%; width: 15vw; border-radius: 5px">
            <thead>
              <tr>
