                                    ...
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <select class="form-select" id="operator" name="operator" required>
                                                ...
                                                <option value="M. Tohar" <?= $data_saw_repair[0]['operator'] == 'M. Tohar' ? 'selected' : '' ?>>M. Tohar</option>
                                                <option value="Purwanta" <?= $data_saw_repair[0]['operator'] == 'Purwanta' ? 'selected' : '' ?>>Purwanta</option>
                                                <option value="Sarjono" <?= $data_saw_repair[0]['operator'] == 'Sarjono' ? 'selected' : '' ?>>Sarjono</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
