              ...
              <div class="box">
                <div class="box-header with-border">
                  <div class="d-flex justify-content-between">
                    <div>
                      <h4 class="box-title">Data Master Man Power GMT</h4>
                      ...
                      <?php if (session()->get('level') < 6) { ?>
                        <a href="<?= base_url() ?>master_man_power_gmt/save_all_mp" class="btn btn-danger ms-2">Update All Skill</a>
                      <?php } ?>
                    </div>
                    <div>
                      <div class="d-flex">
                        <a class="btn btn-primary d-none" id="edit_man_power" href="#">Edit</a>
                        <!-- <form action="<?= base_url() ?>master_man_power_gmt/detail_man_power/delete" method="POST">
                          ...
                          <tr>
                            ...
                            <td>
                              <div class="d-flex justify-content-center">
                                <!-- <a href="<?= base_url() ?>master_man_power_gmt/detail_man_power/<?= $d_mp['id_man_power'] ?>" class="btn btn-primary" style="width: 150px">Edit</a>
                                &nbsp
                                <form action="<?= base_url() ?>master_man_power_gmt/detail_man_power/delete" method="POST">
...
<div class="modal fade modal_tambah_man_power" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" style="display: none;">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <form action="<?= base_url() ?>master_man_power_gmt/add_man_power" method="post">
