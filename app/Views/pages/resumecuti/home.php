                      ...
                      <tbody id="table_cuti">
                        <?php foreach ($data_mp_cuti as $dmc) { ?>
                          <tr>
                            ...
                            <td><a href="<?= base_url() ?>cuti/detail_<?= strtolower(str_replace(' ', '_', $dmc['keterangan'])) ?>/<?= $dmc['id_cuti'] ?>/<?= str_replace(' ', '_', $dmc['keterangan']) ?>" class="btn btn-sm btn-primary">Detail</a></td>
                          </tr>
                        <?php } ?>
                      </tbody>
                      <tfoot>
