              ...
              <div class="box">
                <div class="box-header with-border">
                  <div class="d-flex justify-content-between">
                    <div>
                      <h4 class="box-title">Data Master Man Power Management</h4>
                    ...
                    <div>
                      <div class="d-flex">
                        ...
                        <!-- <form action="<?= base_url() ?>master_man_power_management/detail_man_power/delete" method="POST">
                      ...
                      <tbody>
                        ...
                        foreach ($data_man_power as $d_mp) : ?>
                          <tr>
                            ...
                            <td class="fs-5 text-center" id="status_<?= $index_data_man_power ?>"><?= $d_mp['status'] ?></td>
                            <td>
                              <div class="d-flex justify-content-center">
                                <!-- <a href="<?= base_url() ?>master_man_power_management/detail_man_power/<?= $d_mp['id_man_power'] ?>" class="btn btn-primary" style="width: 150px">Edit</a>
                                &nbsp
                                <form action="<?= base_url() ?>master_man_power_management/detail_man_power/delete" method="POST">
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title" id="myLargeModalLabel">Tambah Man Power Management</h4>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <form action="<?= base_url() ?>master_man_power_management/add_man_power" method="post">
...
<script>
  ...
  function checkedManPower(id_man_power, index) {
    ...
    if (checkedId.length === 1) {
      editManPowerElement.setAttribute('href', `<?= base_url() ?>master_man_power_management/detail_man_power/${checkedId[0]}`);
    }
  ...
  function hapusManPower() {
    ...
    $.ajax({
      url: '<?= base_url() ?>master_man_power_management/detail_man_power/delete',
      type: 'POST',
      data: {
        checkedId: checkedId,
      ...
      success: function(data) {
        ...
        checkedNpk = [];
        console.log(data);
        window.location.href = "<?= base_url() ?>master_man_power_management";
