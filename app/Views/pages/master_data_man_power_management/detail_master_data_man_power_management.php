...
<div class="content-wrapper">
  <div class="container-full">
    ...
    <section class="content">
      <form action="<?= base_url() ?>master_man_power_management/detail_man_power/edit" method="post" enctype="multipart/form-data">
        <div class="row">
          <div class="col-xl-12 col-12">
            <div class="box">
              <div class="box-header with-border">
                <h3 style="font-size: 32px">Detail Man Power Management</h3>
              </div>
              <div class="box-body">
                <div class="row">
