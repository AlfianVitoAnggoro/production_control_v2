                                    ...
                                    <table id="" class="table table-striped mb-0">
                                        ...
                                        <tbody class="form_platecutting_pos">
                                            <!-- <tr class="form_pos" id="form_0_pos">
                                                ...
                                                <td>
                                                    <input type="text" class="form-control" name="tersangkut_kg_pos[]" id="tersangkut_kg_0_pos" value="0" onkeyup="panel_pos(0)" style="width: 75px">
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control" name="overbrush_kg_pos[]" id="overbrush_kg_0_pos" value="0" onkeyup="panel_pos(0)" style="width: 75px">
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control" name="rontok_kg_pos[]" id="rontok_kg_0_pos" value="0" onkeyup="panel_pos(0)" style="width: 75px">
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control" name="lug_patah_kg_pos[]" id="lug_patah_kg_0_pos" value="0" onkeyup="panel_pos(0)" style="width: 75px">
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control" name="patah_kaki_kg_pos[]" id="patah_kaki_kg_0_pos" value="0" onkeyup="panel_pos(0)" style="width: 75px">
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control" name="patah_frame_kg_pos[]" id="patah_frame_kg_0_pos" value="0" onkeyup="panel_pos(0)" style="width: 75px">
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control" name="bolong_kg_pos[]" id="bolong_kg_0_pos" value="0" onkeyup="panel_pos(0)" style="width: 75px">
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control" name="bending_kg_pos[]" id="bending_kg_0_pos" value="0" onkeyup="panel_pos(0)" style="width: 75px">
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control" name="lengket_terpotong_kg_pos[]" id="lengket_terpotong_kg_0_pos" value="0" onkeyup="panel_pos(0)" style="width: 75px">
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control" name="terpotong_panel_pos[]" value="0" id="terpotong_panel_0_pos" style="width: 75px" readonly>
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control" name="tersangkut_panel_pos[]" value="0" id="tersangkut_panel_0_pos" style=" width: 75px" readonly>
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control" name="overbrush_panel_pos[]" value="0" id="overbrush_panel_0_pos" style="width: 75px" readonly>
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control" name="rontok_panel_pos[]" value="0" id="rontok_panel_0_pos" style="width: 75px" readonly>
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control" name="lug_patah_panel_pos[]" value="0" id="lug_patah_panel_0_pos" style="width: 75px" readonly>
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control" name="patah_kaki_panel_pos[]" value="0" id="patah_kaki_panel_0_pos" style="width: 75px" readonly>
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control" name="patah_frame_panel_pos[]" value="0" id="patah_frame_panel_0_pos" style="width: 75px" readonly>
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control" name="bolong_panel_pos[]" value="0" id="bolong_panel_0_pos" style="width: 75px" readonly>
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control" name="bending_panel_pos[]" value="0" id="bending_panel_0_pos" style="width: 75px" readonly>
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control" name="lengket_terpotong_panel_pos[]" value="0" id="lengket_terpotong_panel_0_pos" style="width: 75px" readonly>
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control" name="persentase_reject_internal_pos[]" value="0 %" id="persentase_reject_internal_0_pos" style="width: 100px" readonly>
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control" name="persentase_reject_eksternal_pos[]" value="0 %" id="persentase_reject_eksternal_0_pos" style="width: 100px" readonly>
                                                </td>
                                                <td>
                                    ...
                                    <table id="" class="table table-striped mb-0">
                                        ...
                                        <tbody class="form_platecutting_neg">
                                            <!-- <tr class="form_neg" id="form_0_neg">
                                                ...
                                                <td>
                                                    <input type="text" class="form-control" name="tersangkut_kg_neg[]" id="tersangkut_kg_0_neg" value="0" onkeyup="panel_neg(0)" style="width: 75px">
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control" name="overbrush_kg_neg[]" id="overbrush_kg_0_neg" value="0" onkeyup="panel_neg(0)" style="width: 75px">
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control" name="rontok_kg_neg[]" id="rontok_kg_0_neg" value="0" onkeyup="panel_neg(0)" style="width: 75px">
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control" name="lug_patah_kg_neg[]" id="lug_patah_kg_0_neg" value="0" onkeyup="panel_neg(0)" style="width: 75px">
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control" name="patah_kaki_kg_neg[]" id="patah_kaki_kg_0_neg" value="0" onkeyup="panel_neg(0)" style="width: 75px">
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control" name="patah_frame_kg_neg[]" id="patah_frame_kg_0_neg" value="0" onkeyup="panel_neg(0)" style="width: 75px">
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control" name="bolong_kg_neg[]" id="bolong_kg_0_neg" value="0" onkeyup="panel_neg(0)" style="width: 75px">
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control" name="bending_kg_neg[]" id="bending_kg_0_neg" value="0" onkeyup="panel_neg(0)" style="width: 75px">
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control" name="lengket_terpotong_kg_neg[]" id="lengket_terpotong_kg_0_neg" value="0" onkeyup="panel_neg(0)" style="width: 75px">
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control" name="terpotong_panel_neg[]" value="0" id="terpotong_panel_0_neg" style="width: 75px" readonly>
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control" name="tersangkut_panel_neg[]" value="0" id="tersangkut_panel_0_neg" style=" width: 75px" readonly>
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control" name="overbrush_panel_neg[]" value="0" id="overbrush_panel_0_neg" style="width: 75px" readonly>
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control" name="rontok_panel_neg[]" value="0" id="rontok_panel_0_neg" style="width: 75px" readonly>
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control" name="lug_patah_panel_neg[]" value="0" id="lug_patah_panel_0_neg" style="width: 75px" readonly>
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control" name="patah_kaki_panel_neg[]" value="0" id="patah_kaki_panel_0_neg" style="width: 75px" readonly>
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control" name="patah_frame_panel_neg[]" value="0" id="patah_frame_panel_0_neg" style="width: 75px" readonly>
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control" name="bolong_panel_neg[]" value="0" id="bolong_panel_0_neg" style="width: 75px" readonly>
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control" name="bending_panel_neg[]" value="0" id="bending_panel_0_neg" style="width: 75px" readonly>
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control" name="lengket_terpotong_panel_neg[]" value="0" id="lengket_terpotong_panel_0_neg" style="width: 75px" readonly>
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control" name="persentase_reject_internal_neg[]" value="0 %" id="persentase_reject_internal_0_neg" style="width: 100px" readonly>
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control" name="persentase_reject_eksternal_neg[]" value="0 %" id="persentase_reject_eksternal_0_neg" style="width: 100px" readonly>
                                                </td>
                                                <td>
    ...
    function data_platecutting_pos() {
        ...
        <?php foreach ($plate_pos as $pp) { ?>
			...
			<tr class="form_pos" id="form_${baris}_pos">
                ...
                <td>
                    <input type="text" class="form-control" name="barcode_pos[]" id="barcode_${baris}_pos" onkeyup="deviasi(${baris}, 'pos')" value="<?= trim($pp['barcode']) ?>" style="width: 100px">
                </td>
                <td>
    ...
    function data_platecutting_neg() {
        ...
        <?php foreach ($plate_neg as $pn) { ?>
			...
			<tr class="form_neg" id="form_${baris}_neg">
                ...
                <td>
                    <input type="text" class="form-control" name="barcode_neg[]" id="barcode_${baris}_neg" onkeyup="deviasi(${baris}, 'neg')" value="<?= trim($pn['barcode']) ?>" style="width: 100px">
                </td>
                <td>
    ...
    function add_platecutting_pos() {
        ...
        $('.form_platecutting_pos').append(`
			<tr class="form_pos" id="form_${baris}_pos">
                ...
                <td>
                    <input type="text" class="form-control" name="barcode_pos[]" value="" id="barcode_${baris}_pos" onkeyup="deviasi(${baris}, 'pos')" style="width: 100px">
                </td>
                <td>
    ...
    function add_platecutting_neg() {
        ...
        $('.form_platecutting_neg').append(`
			<tr class="form_neg" id="form_${baris}_neg">
                ...
                <td>
                    <input type="text" class="form-control" name="barcode_neg[]" value="" id="barcode_${baris}_neg" onkeyup="deviasi(${baris}, 'neg')" style="width: 100px">
                </td>
                <td>
