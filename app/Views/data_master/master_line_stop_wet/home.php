                      ...
                      <tbody>
                        <?php foreach ($data_breakdown as $d) : ?>
                          <tr>
                            ...
                            <td>
                              <div class="d-flex">
                                <a href="<?= base_url() ?>line_stop_wet/detail_line_stop_wet/<?= $d['id_breakdown'] ?>" class="btn btn-primary btn-sm">Edit</a>
                                &nbsp
                                <form action="<?= base_url() ?>line_stop_wet/detail_line_stop_wet/delete" method="POST">
...
<div class="modal fade modal_tambah_line_stop" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" style="display: none;">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <form action="<?= base_url() ?>line_stop_wet/add_line_stop_wet" method="post">
