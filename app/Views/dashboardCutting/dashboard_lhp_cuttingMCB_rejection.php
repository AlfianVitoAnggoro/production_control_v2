            ...
            <div class="row">
                <div class="box bg-transparent">
                    <div class="box-body" style="display:flex">
                        <div class="col-2">
                            <form action="<?=base_url()?>dashboard/rejectMCB" method="POST">
            ...
            series: [
                {
                    ...
                    data: [
                        {
                            value: <?=json_encode($data_reject_all_month[date('n', mktime(0, 0, 0, $previous_date, 10)) - 1])?>,
                            name: 'Monday',
                            itemStyle: {
                                color: 'grey'
                            }
                        ...
                        {
                            value: 100 - (<?=json_encode($data_reject_all_month[date('n', mktime(0, 0, 0, $previous_date, 10)) - 1])?>),
                            name: 'invisible',
                            itemStyle: {
                                color: 'red'
                            }
            ...
            series: [
                {
                    ...
                    data: [
                        {
                            value: <?=json_encode($data_reject_all_month[date('n', mktime(0, 0, 0, $current_date, 10)) - 1])?>,
                            name: 'Monday',
                            itemStyle: {
                                color: 'grey'
                            }
                        ...
                        {
                            value: 100 - (<?=json_encode($data_reject_all_month[date('n', mktime(0, 0, 0, $current_date, 10)) - 1])?>),
                            name: 'invisible',
                            itemStyle: {
                                color: 'orange'
                            }
                ...
                column: {
                    ...
                    events: {
                        click : function(e) {
                            ...
                            $.ajax({
                                url: '<?= base_url('dashboard/rejectMCB/get_detail_rejection') ?>',
                                type: 'POST',
                                data: {
                                    date: date,
                                    line: line
