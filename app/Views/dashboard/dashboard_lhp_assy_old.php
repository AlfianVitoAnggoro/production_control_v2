                                ...
                                <div class="row">
                                    ...
                                    <div class="col-3" style="display:flex;">
                                        <select class="form-select" name="baby_filter" id="baby_filter">
                                            ...
                                            <option value="grup">By Grup</option>
                                            <option value="kasubsie">By Kasubsie</option>
                                        </select>
                                        &nbsp;   
...
<script>
    ...
    Highcharts.chart('container', {
        ...
        series: [
            ...
            <?php if ($child_filter != null AND $child_filter != '0' AND $child_filter != 0) { ?>
                {
                    name: 'Shift 1',
