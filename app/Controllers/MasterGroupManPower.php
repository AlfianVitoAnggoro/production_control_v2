    ...
    for ($i = 1; $i <= 3; $i++) {
      ...
      for ($j = 0; $j < count($mesin_indirect); $j++) {
        ...
        $data_detail_group_man_power_indirect = [
          ...
          'status' => $this->request->getPost('status_pos_indirect')[$j] !== '' ? $this->request->getPost('status_pos_indirect')[$j] : 'Aktif',
        ];
      ...
      for ($k = 0; $k < count($line); $k++) {
        ...
        for ($j = 0; $j < count($mesin); $j++) {
          ...
          $data_detail_group_man_power = [
            ...
            'status' => $this->request->getPost('status_pos_' . $k)[$j] !== '' ? $this->request->getPost('status_pos_' . $k)[$j] : 'Aktif',
          ];
